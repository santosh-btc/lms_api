...
class LeaveTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create leave_type" do
    assert_difference('LeaveType.count') do
      post leave_types_url, params: { leave_type: { descripton: @leave_type.descripton, name: @leave_type.name } }
    end
  ...
  test "should update leave_type" do
    patch leave_type_url(@leave_type), params: { leave_type: { descripton: @leave_type.descripton, name: @leave_type.name } }
